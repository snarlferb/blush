...
- [ ] So in other words, you can have them enabled/disabled simultaneously (as in an X/O Panel you simultaneously flip, changing a *LAYER* of binding targets) or you can have them discriminated, so that they dont exist, atleast not from the keyboard.
